(function (root, factory) {
  ...
  function buildCss(settings) {
    ...
    return [
      ...
      '#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-quick-button,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-tab-focus,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-tab-order,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-rail-toggle{display:none!important;}',
