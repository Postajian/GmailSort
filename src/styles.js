  ...
  function buildCss(settings) {
    ...
    return [
      ...
      '@media print{'
        ...
        + '#gmail-view-next-ui .gvn-rail-toggle,'
      ...
      '#gmail-view-next-ui .gvn-rail-toggle{position:absolute;left:268px;top:5px;height:22px;padding:0 10px;border:1px solid #000;background:#fff;color:#000;font:600 10px/20px Arial,sans-serif;letter-spacing:.6px;text-transform:uppercase;cursor:pointer;pointer-events:auto;}',
      '#gmail-view-next-ui .gvn-rail-toggle[data-active="true"]{background:var(--gvn-gold);}',
      // Quick buttons appear only when the Edit menu is open (like Labels/Columns/Inspect).
      '#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-quick-button,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-tab-focus,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-tab-order,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-rail-toggle,#gmail-view-next-ui:not([data-edit-menu="true"]) .gvn-bg-toggle{display:none!important;}',
      ...
      '#gmail-view-next-ui[data-editing="true"] .gvn-quick-button,#gmail-view-next-ui[data-label-editing="true"] .gvn-quick-button,#gmail-view-next-ui[data-editing="true"] .gvn-tab-focus,#gmail-view-next-ui[data-label-editing="true"] .gvn-tab-focus,#gmail-view-next-ui[data-editing="true"] .gvn-tab-order,#gmail-view-next-ui[data-label-editing="true"] .gvn-tab-order,#gmail-view-next-ui[data-editing="true"] .gvn-rail-toggle,#gmail-view-next-ui[data-label-editing="true"] .gvn-rail-toggle{display:none!important;}',
