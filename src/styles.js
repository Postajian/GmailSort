(function (root, factory) {
  ...
  function buildCss(settings) {
    ...
    return [
      ...
      '#gmail-view-next-ui[data-edit-menu="true"] .gvn-edit-button{right:260px!important;}',
      ...
      '#gmail-view-next-ui .gvn-inspect-button{position:absolute;right:92px;top:5px;height:22px;padding:0 10px;border:1px solid #000;border-radius:6px;background:#fff;color:#000;font:600 10px/20px Arial,sans-serif;letter-spacing:.8px;text-transform:uppercase;cursor:pointer;pointer-events:auto;}',
